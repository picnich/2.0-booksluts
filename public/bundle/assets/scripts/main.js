(() => {
    ...
    "node_modules/gsap/dist/gsap.js"(exports, module) {
      (function(global2, factory) {
        ...
        var _config = {
          ...
          var v = animation.vars, callback = v[type], prevContext = _context3, context = animation._ctx, params, scope, result;
          if (!callback) {
            return;
          }
          ...
          _self = {
            ...
            wake: function wake() {
              if (_coreReady) {
                if (!_coreInitted3 && _windowExists3()) {
                  ...
                  _globals.gsap = gsap6;
                  (_win3.gsapVersions || (_win3.gsapVersions = [])).push(gsap6.version);
                  _install(_installScope || _win3.GreenSockGlobals || !_win3.gsap && _win3 || {});
                  _raf = _win3.requestAnimationFrame;
            ...
            sleep: function sleep() {
              (_raf ? _win3.cancelAnimationFrame : clearTimeout)(_id);
              _tickerActive = 0;
              _req = _emptyFunc;
            },
        ...
        var Animation = function() {
          ...
          _proto.timeScale = function timeScale(value) {
            ...
            this.totalTime(_clamp3(-Math.abs(this._delay), this._tDur, tTime), true);
            _setEnd(this);
        ...
        var Context = function() {
          ...
          _proto5.add = function add(name, func, scope) {
            ...
            self2.last = f;
            return name === _isFunction3 ? f(self2) : name ? self2[name] = f : f;
          };
        ...
        var _gsap = {
          ...
          quickSetter: function quickSetter(target, property, unit) {
            ...
            if (target.length > 1) {
              var setters = target.map(function(t) {
                return gsap6.quickSetter(t, property, unit);
              }), l = setters.length;
              return function(value) {
                var i = l;
                while (i--) {
          ...
          quickTo: function quickTo(target, property, vars) {
            var _merge2;
            var tween = gsap6.to(target, _merge((_merge2 = {}, _merge2[property] = "+=0.1", _merge2.paused = true, _merge2), vars || {})), func = function func2(value, start, startIsRelative) {
        ...
        Tween.version = Timeline.version = gsap6.version = "3.12.2";
        _coreReady = 1;
        ...
        var _win$1, _doc$1, _docElement, _pluginInitted, _tempDiv, _tempDivStyler, _recentSetterPlugin, _reverting$1, _windowExists$1 = function _windowExists4() {
          ...
          target._gsap || gsap6.core.getCache(target);
          ...
          if (_windowExists$1() && window.document) {
            ...
            _reverting$1 = gsap6.core.reverting;
            _pluginInitted = 1;
          }
        ...
        gsap6.core.getStyleSaver = _getStyleSaver;
  ...
  var require_Flip = __commonJS({
    "node_modules/gsap/dist/Flip.js"(exports, module) {
      (function(global2, factory) {
        ...
        "use strict";
        var _doc3, _win3, _docElement, _body3, _divContainer, _svgContainer, _identityMatrix, _gEl, _transformProp2 = "transform", _transformOriginProp = _transformProp2 + "Origin", _hasOffsetBug, _setDoc = function _setDoc2(element) {
          ...
          return _win3.pageYOffset || _doc3.scrollTop || _docElement.scrollTop || _body3.scrollTop || 0;
        }, _getDocScrollLeft = function _getDocScrollLeft2() {
          return _win3.pageXOffset || _doc3.scrollLeft || _docElement.scrollLeft || _body3.scrollLeft || 0;
        ...
        var _id = 1, _toArray2, gsap6, _batch, _batchAction, _body$1, _closestTenth, _getStyleSaver, _forEachBatch = function _forEachBatch2(batch, name) {
          ...
          if (simple || !parent) {
            ...
            rotation = _round3(Math.atan2(matrix.b, matrix.a) * _RAD2DEG);
            skewX = _round3(Math.atan2(matrix.c, matrix.d) * _RAD2DEG + rotation) % 360;
        ...
        var ElementState = function() {
          ...
          _proto2.update = function update(props, simple) {
            var self2 = this, element = self2.element, getProp = gsap6.getProperty(element), cache = gsap6.core.getCache(element), bounds = element.getBoundingClientRect(), bbox = element.getBBox && typeof element.getBBox === "function" && element.nodeName.toLowerCase() !== "svg" && element.getBBox(), m = simple ? new Matrix2D(1, 0, 0, 1, bounds.left + _getDocScrollLeft(), bounds.top + _getDocScrollTop()) : getGlobalMatrix(element, false, false, true);
  ...
  var _parsePosition = function _parsePosition2(value, trigger, scrollerSize, direction, scroll2, marker, markerScroller, self2, scrollerBounds, borderWidth, useFixedPosition, scrollerMax, containerAnimation, clampZeroProp) {
  ...
  import_gsap2.gsap.registerPlugin(ScrollTrigger2, import_Flip.Flip);
  ...
  // src/assets/scripts/modules/app.js
  import_gsap3.gsap.registerPlugin(ScrollTrigger2, import_Flip2.Flip);
